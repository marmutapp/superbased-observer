...
func main() {
	// Propagate the build version to the org-server package so outbound
	// artifacts (the [email] alert footer) carry it.
	orgserver.AppVersion = version
