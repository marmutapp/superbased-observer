          ...
          <Card className="p-3">
            ...
            {data.rules.length === 0 ? (
              <EmptyState
                ...
                body="Add a rule above to watch a trajectory metric — error rate, windowed cost, or p95 latency. When it crosses your threshold (with cooldown) the rule records an event and posts to your webhook, before the invoice."
                helpId="tab.obs_alerts"
              />
            ) : (
