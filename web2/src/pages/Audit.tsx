  ...
  return (
    <>
      ...
      {error ? (
        ...
        <EmptyState
          icon={ScrollText}
          title="No audited disclosures yet"
          body="This log records every privacy-sensitive read — who viewed which developers' data, drilled into a team, or opened captured messages — before the data is returned. It fills as admins use the People, Teams, and Sessions pages."
          helpId="tab.audit"
        />
      ) : (
        <>
