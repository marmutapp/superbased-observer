    ...
    <Card>
      ...
      {error ? (
        ...
        <EmptyState
          variant="inline"
          icon={ShieldCheck}
          title="No guard-active agents yet"
          body="Agents appear here once a developer's node runs the guardrail (egress-policy) engine and pushes guard events. Enable [guard] on a node, or wait for the first guarded tool call to land."
        />
      ) : (
