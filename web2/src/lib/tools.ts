// Tool registry — color + label + provider class for every AI tool the
// observer can capture. MIRROR of web/src/lib/tools.ts; the --tool-* custom
// properties live in styles/tokens.css.
