...
// MIRROR of web/src/components/primitives/HeroStat.tsx — wide hero KPI tile for
// a page-leading metric. ~2-3× a StatCard, beefier value font, saturated
// radial gradient. Sits alongside a strip of StatCards in the same row.
