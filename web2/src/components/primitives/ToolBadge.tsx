...
// MIRROR of web/src/components/primitives/ToolBadge.tsx — provider-colored
// tool identity marks (ToolDot / ToolGlyphFrame / ToolBadge).

// ToolDot — bare provider-colored dot for compact contexts.
...
// ToolGlyphFrame — tinted rounded-square frame wrapping the per-tool glyph.
