...
// MIRROR of web/src/components/primitives/Skeleton.tsx — pulse skeleton
// placeholder. The animate-shimmer utility is defined in src/index.css and
// uses --ease from tokens.css so theme switches stay consistent.
...
// StatStripSkeleton is a row of N StatCardSkeletons — the common page-top
// loading state for the KPI strip.
