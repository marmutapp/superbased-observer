// MIRROR of web/src/components/charts/ChartTooltip.tsx — Recharts custom
// tooltip styled with the design tokens, so it flips on theme switch without
// dark: variants.
          ...
          .map((p, i) => (
            <li key={i} className="flex items-center gap-2 text-fg-1">
              <span
                ...
                style={{
                  background: String(p.color ?? p.fill ?? "var(--accent)"),
                }}
              />
