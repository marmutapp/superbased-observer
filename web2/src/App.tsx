...
import { ObsEvalRunPage } from "@/pages/obs/EvalRun";
import { ObsCostPage } from "@/pages/obs/Cost";
import { ObsEndUsersPage } from "@/pages/obs/EndUsers";
import { ObsAlertsPage } from "@/pages/obs/Alerts";
import { ObsAdmissionPage } from "@/pages/obs/Admission";
  ...
  return (
    <Layout>
      <RouteErrorBoundary key={pathname}>
        ...
        <Route path="/trajectories/evals/:runId" element={<ObsEvalRunPage />} />
        <Route path="/trajectories/cost" element={<ObsCostPage />} />
        <Route path="/trajectories/end-users" element={<ObsEndUsersPage />} />
        <Route path="/trajectories/alerts" element={<ObsAlertsPage />} />
        <Route path="/trajectories/admission" element={<ObsAdmissionPage />} />
