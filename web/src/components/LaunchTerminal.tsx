        ...
        if (typeof ev.data === "string") {
          ...
          try {
            ...
            if (m.t === "exit") {
              ...
              // Taken over locally, or the owner/admin revoked control. Input
              // stops; the socket may then close (admin kill) and reconnect as a
              // viewer via the dock's rehydrate. Toast it in this seat (§6
              // decision 5) and arm the regain toast for the next grant.
              wasRevokedRef.current = true;
              pushToast("Terminal control passed to another viewer", "warn");
              setControl("revoked");
            }
          } catch {
