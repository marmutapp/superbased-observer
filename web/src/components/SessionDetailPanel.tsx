    ...
    >
      <div className="space-y-5 px-5 pb-5 pt-3">
        ...
        <section className="space-y-2">
          ...
          >
            {messages.data && (
              <MessagesTable rows={messages.data.messages} focusMid={focusMid} />
            )}
          </ChartState>
...
// PredictLimitSection renders the proxy-gated 5h/weekly limit gauge. In
// v1 the capture path is not yet live, so it shows the help-icon "route
// through the proxy to unlock" state. Once snapshots land (Phase C) the
// available branch renders the real utilization + reset clocks.
