...
const (
	...
	// Types >= 3 are reserved (F3 adds turn-boundary frames here); a Phase-0
	// decoder surfaces them as TypeUnknown.
)
...
// type; both are nil for TypeUnknown (the raw payload is discarded after the
