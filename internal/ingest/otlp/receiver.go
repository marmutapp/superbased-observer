...
func New(opts Options) (*Receiver, error) {
	if opts.Handler == nil {
		return nil, errors.New("ingest/otlp: Handler is required")
	}
	if opts.Logger == nil {
...
func (r *Receiver) Start() {
	if r.grpcServer != nil {
		...
		r.opts.Logger.Info("ingest/otlp: gRPC logs receiver listening", "addr", r.grpcLn.Addr().String())
	}
	if r.httpServer != nil {
		go func() {
		...
		r.opts.Logger.Info("ingest/otlp: HTTP logs receiver listening", "addr", r.httpLn.Addr().String())
	}
}
