...
type VerbosityResponse struct {
	...
	AuthoredMeasuredActions int64  `json:"authored_measured_actions"`
	AuthoredTotalActions    int64  `json:"authored_total_actions"`
	BackfillRecommended     bool   `json:"backfill_recommended"`
...
func buildVerbosityResponse(sessionID string, b *verbosity.Breakdown, captured, totalAuthored int64, cost *verbosityCost) VerbosityResponse {
	...
	resp := VerbosityResponse{
		...
		AuthoredMeasuredActions: captured,
		AuthoredTotalActions:    totalAuthored,
		BackfillRecommended:     totalAuthored > 0 && captured == 0,
