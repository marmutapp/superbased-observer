...
func TestArmVerbsRequireConfirmToken(t *testing.T) {
	...
	for _, path := range []string{"/api/remote/enable", "/api/remote/disable", "/api/remote/rotate", "/api/remote/add-device", "/api/remote/allow-terminal", "/api/remote/approve-execute", "/api/remote/standing-terminal/mint", "/api/remote/standing-terminal/revoke", "/api/remote/tailscale/login", "/api/remote/tailscale/install"} {
		// Wrong method → 405.
