...
var defaultPricing = map[string]Pricing{
	...
	// $2/$10 in effect through 2026-08-31; standard rates rise to $3/$15
	// (cache 3.75/6/0.30) starting 2026-09-01 — bump this row then. Source:
	// platform.claude.com/docs/en/about-claude/pricing (fetched 2026-07-04).
