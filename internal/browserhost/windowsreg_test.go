...
func TestNewWindowsRegistrarValidatesOptions(t *testing.T) {
	...
	if _, err := NewWindowsRegistrar(WindowsOptions{WindowsHome: "/mnt/c/Users/u", WSLDistro: "Ubuntu", LinuxLauncherPath: "/x", Registry: fake, ExtensionID: "NOT-A-VALID-ID"}); err == nil {
		t.Error("invalid ExtensionID must error in the constructor")
	}
	// The placeholder sentinel and a real id both pass.
	if _, err := NewWindowsRegistrar(WindowsOptions{WindowsHome: "/mnt/c/Users/u", WSLDistro: "Ubuntu", LinuxLauncherPath: "/x", Registry: fake, ExtensionID: PlaceholderExtensionID}); err != nil {
...
func TestWindowsWriteAtomicReplace(t *testing.T) {
	...
	opts2.ExtensionID = "ponmlkjihgfedcbaponmlkjihgfedcba"
