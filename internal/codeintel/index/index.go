...
// AUTO-index because walking it enumerates a whole home/drive tree: a
// filesystem root, the daemon's own home directory, a WSL drive mount
// (/mnt/<drive>), or a home container whose parent segment is "Users"/"home"
// (…/Users/<name>, …/home/<name>). A deeper folder under one of these (e.g.
// …/Users/<name>/OneDrive/Desktop/project) is NOT blocked — only the
// container itself. Explicit `observer index` (force=true) bypasses this.
