...
// escaping. winPath derives from a directory name under /mnt/c/Users,
// so a single quote in it is doubled (” — the PowerShell single-quote
// escape) before interpolation; otherwise a crafted home-directory name
// could break out of the string literal and inject PowerShell.
