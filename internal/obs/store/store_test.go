...
func TestMigrateIdempotent(t *testing.T) {
	...
	// obs_schema_meta records the latest version (8 after the G22 wave-2
	// egress realized-outcome columns, migration 0008), host schema_meta
	// untouched.
	var v string
	...
	if v != "8" {
		t.Errorf("obs_schema_meta version = %q, want 8", v)
	}
}
