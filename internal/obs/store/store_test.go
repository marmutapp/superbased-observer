...
func TestMigrateIdempotent(t *testing.T) {
	...
	// obs_schema_meta records the latest version (6 after the node-side alert
	// events table, migration 0006), host schema_meta untouched.
	var v string
	...
	if v != "6" {
		t.Errorf("obs_schema_meta version = %q, want 6", v)
	}
}
