...
func TestMigrateIdempotent(t *testing.T) {
	...
	// obs_schema_meta records the latest version (5 after the admission audit
	// tables, migration 0005), host schema_meta untouched.
	var v string
	...
	if v != "5" {
		t.Errorf("obs_schema_meta version = %q, want 5", v)
	}
}
