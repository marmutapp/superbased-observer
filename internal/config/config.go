		...
		Observer: ObserverConfig{
			...
			Watch: WatchConfig{
				...
				EnabledAdapters: []string{
					"claude-code", "codex", "cline", "cline-cli", "roo-code", "cursor", "copilot", "copilot-cli", "cowork", "opencode", "openclaw", "pi", "gemini-cli", "antigravity", "antigravity-cli", "hermes", "kilo-code", "kilo-code-cli",
				},
			},
