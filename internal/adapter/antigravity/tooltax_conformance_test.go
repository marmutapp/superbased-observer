...
// re-implementation.
//
// The classifier is mapToolName (classify.go), a normalized-key switch shared by the desktop and CLI adapters.
...
var tooltaxTools = []string{models.ToolAntigravity, models.ToolAntigravityCLI}
