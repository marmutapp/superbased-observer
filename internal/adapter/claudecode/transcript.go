...
func parseTranscript(ctx context.Context, r io.Reader) ([]models.TranscriptMessage, error) {
	br := bufio.NewReaderSize(r, 1<<20)
	b := transcriptBuilder{b: transcriptutil.New()}
	for {
