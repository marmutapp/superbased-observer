...
func (a *Adapter) ReadTranscript(ctx context.Context, sess models.Session, sourceHints []string) ([]models.TranscriptMessage, error) {
	...
	defer f.Close()
	return parseRolloutTranscript(ctx, f)
}
...
func parseRolloutTranscript(ctx context.Context, r io.Reader) ([]models.TranscriptMessage, error) {
	br := bufio.NewReaderSize(r, 1<<20)
	b := rolloutBuilder{b: transcriptutil.New()}
	for {
