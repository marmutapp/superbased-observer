...
func New(ctx context.Context, cfg config.Config, logger *slog.Logger) (*Server, error) {
	...
	return &Server{cfg: cfg, db: db, org: org, logger: logger, handler: handler, evaluator: evaluator, ccScheduler: ccScheduler, codexScheduler: codexScheduler, copilotSchedulers: copilotSchedulers}, nil
}
