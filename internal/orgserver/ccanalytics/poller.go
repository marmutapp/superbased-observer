...
const (
	...
	MetricTokensCacheRd = "tokens_cache_read"     //nolint:gosec // G101: metric-name string, not a credential
	MetricTokensCacheCr = "tokens_cache_creation" //nolint:gosec // G101: metric-name string, not a credential
